...
%>
<form action="Forumthreesave">
<table>
<tr>
<!在这显示用户id>
<td>回复:<%=r%><input type="text" name="reply"></td>
<td>
论坛id：<input type="text" name="forumid" value="<%=ft.getForumid() %>" >
我的楼层id<input type="text" name="forumtwoid" value="<%=ft.getId() %>">
回复给这个id：<input type="text" name="touserid" value="<%=r%>">
我的 自己的d:<input type="text" name="userid" value="456">
</td>
</tr>
<tr>
<td><input type="submit" value="回复1"></td>
</tr>
</table>
</form>
...
<tr>
<!回复给谁的id>
<td>回复:<%=ft.getUserid()%><input type="text" name="reply"></td>
<td>
论坛id：<input type="text" name="forumid" value="<%=ft.getForumid() %>" >
我的楼层id<input type="text" name="forumtwoid" value="<%=ft.getId() %>">
回复给这个id：<input type="text" name="touserid" value="<%=ft.getUserid()%>">
我的 自己的d:<input type="text" name="userid" value="789">
</td>
</tr>
<tr>
<td><input type="submit" value="回复2"></td>
</tr>
</table>
</form>
</div>
...
%>
<div style="background:#acc">
<form action="Forumtwosave?forumid=<%=f.getId() %>" method="post" enctype="multipart/form-data">
<table>
<tr>
我的楼层<input type="text" name="sequence" value="<%=ri+1%>">
<td>回复楼主:</td>
<td><input type="text" name="reply"/></td>
<td>我的 自己的d:<input type="text" name="userid" value="789"></td>
</tr>
<tr>
<td><input type="submit" value="回复3"></td>
</tr>
</table>
</form>
</div>
