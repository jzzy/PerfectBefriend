...
<div class="cont">
   ...
   <h1 class="tit tit6"><a href="<%=request.getContextPath()%>/weiXniBDN" class="fl">&lt; 返回</a></h1>
   <div class="sstop">
...
<li><a href="<%=request.getContextPath()%>/webWeiXinHotarea?pageSize=10&currentPage=1">首页</a></li>
<li><a href="<%=request.getContextPath()%>/webWeiXinHotarea?pageSize=10&currentPage=<%=currentPage-1%>">上一页</a></li>
<li><a href="<%=request.getContextPath()%>/webWeiXinHotarea?pageSize=10&currentPage=<%=currentPage+1%>">下一页</a></li>
<li><a href="<%=request.getContextPath()%>/webWeiXinHotarea?pageSize=10&currentPage=<%=a %>">末页</a></li>
</ul>
