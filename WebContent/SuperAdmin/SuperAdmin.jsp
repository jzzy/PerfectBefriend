...
<head>
<meta charset="utf-8" />
<title>家长天地后台登入</title>

<script type="text/javascript">
	function check()
	{
		  var valuea = document.getElementById("Admin").value;
	...
	<div style="background: #adc; width: 690px; height: 110px;">
		...
		<form action="SuperAdminLogin" method="post" enctype="multipart/form-data">
			<table cellpadding="0" cellspacing="0" style="width: 700px;">
				<tr>
					<td colspan="2">账户：<input type="text" id="Admin" name="Admin" />
					</td>
				...
				<tr>
					...
					<td colspan="2">密码：<input type="password" id="password"
						name="Pwd" />
					</td>
				</tr>
				<tr>
